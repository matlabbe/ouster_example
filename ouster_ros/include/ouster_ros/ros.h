 ...
 * @param[in] filter_param_a parameter of the intensity filter using this quadratic equation with x as the range: ax^2 + bx + c
 * @param[in] filter_param_b parameter of the intensity filter using this quadratic equation with x as the range: ax^2 + bx + c
 * @param[in] filter_param_c parameter of the intensity filter using this quadratic equation with x as the range: ax^2 + bx + c
